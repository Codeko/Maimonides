...
public class MaimonidesInputBlocker extends Task.InputBlocker {

    private static final Logger logger = Logger.getLogger(MaimonidesInputBlocker.class.getName());
    private JDialog modalDialog = null;

    public MaimonidesInputBlocker(Task task, Task.BlockingScope scope, Object target, ApplicationAction action) {
