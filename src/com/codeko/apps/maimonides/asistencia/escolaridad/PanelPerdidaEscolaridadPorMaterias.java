/*
 * PanelPerdidaEscolaridadPorMaterias.java
 *
 * Created on 04-jun-2009, 11:10:24
 */
 ...
 * @author Codeko
 */
public class PanelPerdidaEscolaridadPorMaterias extends javax.swing.JPanel implements IPanel {

    CodekoAutoTableModel<DatoPerdidaEscolaridadPorMaterias> modelo = new CodekoAutoTableModel<DatoPerdidaEscolaridadPorMaterias>(DatoPerdidaEscolaridadPorMaterias.class);
    boolean cargado = false;

    /** Creates new form PanelPerdidaEscolaridadPorMaterias */
    public PanelPerdidaEscolaridadPorMaterias() {
        initComponents();
    ...
    private class ActualizarTask extends org.jdesktop.application.Task<ArrayList<DatoPerdidaEscolaridadPorMaterias>, Void> {
        ...
        ActualizarTask(org.jdesktop.application.Application app) {
            ...
            try {
                ...
                Logger.getLogger(PanelPerdidaEscolaridadPorMaterias.class.getName()).log(Level.SEVERE, null, ex);
            }
            fecha = Fechas.toGregorianCalendar(tfFecha.getDate());
        }

        @Override
        protected ArrayList<DatoPerdidaEscolaridadPorMaterias> doInBackground() {
            ...
            Object oPorcent = spPorcent.getValue();
            ArrayList<DatoPerdidaEscolaridadPorMaterias> ret = DatoPerdidaEscolaridadPorMaterias.getDatosPerdidaEscolaridad(Num.getInt(oPorcent), panelCBCursosGrupos1.getCurso(), panelCBCursosGrupos1.getUnidad(), null, fecha);
            return ret;
        }

        @Override
        protected void succeeded(ArrayList<DatoPerdidaEscolaridadPorMaterias> result) {
    ...
    private void initComponents() {
        ...
        setName("maimonides.paneles.faltas.informes.perdida_evaluacion_materias"); // NOI18N
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.codeko.apps.maimonides.MaimonidesApp.class).getContext().getActionMap(PanelPerdidaEscolaridadPorMaterias.class, this);
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.codeko.apps.maimonides.MaimonidesApp.class).getContext().getResourceMap(PanelPerdidaEscolaridadPorMaterias.class);
